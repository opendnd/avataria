...
var species = ['dragonborn', 'human'].sample();

var male      = require(dataDir + '/' + species + '-male.json'),
    female    = require(dataDir + '/' + species + '-female.json'),
    colors    = require(dataDir + '/' + species + '-colors.json'),
